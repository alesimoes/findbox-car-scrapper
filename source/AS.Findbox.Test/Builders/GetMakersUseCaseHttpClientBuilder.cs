...
{
    public static class GetMakersUseCaseHttpClientBuilder
    {
        private static MockHttpMessageHandler _mockHttp;

        public static HttpClient BuildGetMakers(this HttpClient httpClient)
        {
        ...
        public static HttpClient SetupMakers(this HttpClient httpClient)
        {
        ...
        public static HttpClient SetupInvalidMakers(this HttpClient httpClient)
        {
            var response = new HttpResponseMessage(System.Net.HttpStatusCode.OK);
